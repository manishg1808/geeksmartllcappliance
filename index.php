...
<!-- 8. NEW SEO SECTION: LOCAL SERVICE COVERAGE & REGIONAL HUBS -->
<section style="padding: 5rem 0; background: var(--bg-light); border-bottom: 1px solid var(--border-light);" id="service-areas">
  <div class="container">
    <div style="text-align: center; max-width: 740px; margin: 0 auto 3rem;">
      <div style="color: var(--primary); font-weight: 700; font-size: 0.875rem; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 0.5rem;">Regional Coverage</div>
      <h2 style="font-size: 2.5rem; margin-bottom: 1rem;" class="text-gradient">British Columbia Local Service Hubs</h2>
      <p style="color: var(--text-muted); font-size: 1rem;">Mobile technicians dispatched same-day across major municipalities in BC.</p>
    </div>
    ...
    <div class="grid grid-cols-4">
      <div style="background: #ffffff; padding: 1.75rem; border-radius: var(--radius-lg); border: 1px solid var(--border-light); box-shadow: var(--shadow-sm);">
        <h4 style="font-size: 1.1rem; color: var(--primary); margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.4rem;">
          <i data-lucide="map-pin" style="width: 18px; height: 18px;"></i> Vancouver Hub
        </h4>
        <p style="font-size: 0.85rem; color: var(--text-muted); line-height: 1.5; margin-bottom: 1rem;">
          Downtown, Kitsilano, Mount Pleasant, East Van & West End.
        </p>
        <span style="font-size: 0.775rem; font-weight: 700; color: var(--success);">⚡ 15 Min Response Time</span>
      </div>

      <div style="background: #ffffff; padding: 1.75rem; border-radius: var(--radius-lg); border: 1px solid var(--border-light); box-shadow: var(--shadow-sm);">
        <h4 style="font-size: 1.1rem; color: var(--primary); margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.4rem;">
          <i data-lucide="map-pin" style="width: 18px; height: 18px;"></i> Surrey Hub
        </h4>
        <p style="font-size: 0.85rem; color: var(--text-muted); line-height: 1.5; margin-bottom: 1rem;">
          Whalley, Newton, Cloverdale, Fleetwoods & South Surrey.
        </p>
        <span style="font-size: 0.775rem; font-weight: 700; color: var(--success);">⚡ Same-Day Onsite</span>
      </div>

      <div style="background: #ffffff; padding: 1.75rem; border-radius: var(--radius-lg); border: 1px solid var(--border-light); box-shadow: var(--shadow-sm);">
        <h4 style="font-size: 1.1rem; color: var(--primary); margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.4rem;">
          <i data-lucide="map-pin" style="width: 18px; height: 18px;"></i> Victoria & Island Hub
        </h4>
        <p style="font-size: 0.85rem; color: var(--text-muted); line-height: 1.5; margin-bottom: 1rem;">
          Saanich, Esquimalt, Oak Bay, Langford & Sidney.
        </p>
        <span style="font-size: 0.775rem; font-weight: 700; color: var(--success);">⚡ Remote & Mobile</span>
      </div>

      <div style="background: #ffffff; padding: 1.75rem; border-radius: var(--radius-lg); border: 1px solid var(--border-light); box-shadow: var(--shadow-sm);">
        <h4 style="font-size: 1.1rem; color: var(--primary); margin-bottom: 0.5rem; display: flex; align-items: center; gap: 0.4rem;">
          <i data-lucide="map-pin" style="width: 18px; height: 18px;"></i> Burnaby & Tri-Cities
        </h4>
        <p style="font-size: 0.85rem; color: var(--text-muted); line-height: 1.5; margin-bottom: 1rem;">
          Metrotown, Brentwood, Coquitlam, Port Moody & New West.
        </p>
        <span style="font-size: 0.775rem; font-weight: 700; color: var(--success);">⚡ Priority Dispatch</span>
      </div>
    </div>

    <!-- Mention & Coverage Note Banner for Regional Hubs Section -->
    <div style="margin-top: 2rem; background: #ffffff; border: 1px solid var(--border-light); border-radius: var(--radius-lg); padding: 1.5rem 2rem; box-shadow: var(--shadow-sm); display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1.25rem;">
      <div style="display: flex; align-items: center; gap: 1rem;">
        <div style="width: 44px; height: 44px; border-radius: 50%; background: var(--success-subtle); color: var(--success); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
          <i data-lucide="map" style="width: 22px; height: 22px;"></i>
        </div>
        <div>
          <h4 style="font-size: 1.05rem; font-weight: 800; color: var(--text-main);">Don't See Your Specific Neighborhood Listed?</h4>
          <p style="font-size: 0.875rem; color: var(--text-muted); margin-top: 0.2rem;">We provide extended mobile service coverage across all surrounding suburban areas and remote virtual diagnostic support everywhere in BC.</p>
        </div>
      </div>
      <a href="tel:<?php echo PHONE_RAW; ?>" class="btn btn-outline btn-sm">
        <i data-lucide="phone-call" style="width: 16px; height: 16px;"></i> Check Coverage Availability
      </a>
    </div>
  </div>
</section>
